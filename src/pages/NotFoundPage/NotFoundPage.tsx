export const NotFoundPage = () => {
  ...
  <div className="container flex items-center min-h-screen px-6 py-12 mx-auto">
      <div>
          <p className="text-sm font-medium text-blue-500 dark:text-blue-400">404 ошибка</p>
         ...
         <h1 className="mt-3 text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl">Данной страницы не существует</h1>
          <p className="mt-4 text-gray-500 dark:text-gray-400">Извините, но страницы, которую вы ищите не существует или она была удалена</p> 
